================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Jcad3Glb プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Jcad3Glb には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Jcad3Glb アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Jcad3Glb.h
   ...
   CJcad3GlbApp アプリケーション クラスを宣言します。

Jcad3Glb.cpp
   これは、アプリケーション クラス CJcad3GlbApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Jcad3Glb.ico
   ...
   アイコンはメイン リソース ファイル Jcad3Glb.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Jcad3Glb.rc ファイル内
...
Jcad3GlbDoc.h, Jcad3GlbDoc.cpp - ドキュメント
   これらのファイルは CJcad3GlbDoc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CJcad3GlbDoc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Jcad3GlbView.h, Jcad3GlbView.cpp - ドキュメントのビュー
   これらのファイルは CJcad3GlbView クラスを含みます。
   CJcad3GlbView オブジェクトは CJcad3GlbDoc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Jcad3Glb.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
